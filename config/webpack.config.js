  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@app': path.resolve(paths.appPath, 'src/app'),
        '@asset': path.resolve(paths.appPath, 'src/app/asset'),
        '@common': path.resolve(paths.appPath, 'src/app/common'),
        '@home': path.resolve(paths.appPath, 'src/app/home'),
        '@curation': path.resolve(paths.appPath, 'src/app/curation'),
